...
// Filter today's data by search input
...
return (
            ...
            <Card className="bg-white shadow-xl border-0 rounded-lg">
                <CardHeader className="bg-blue-50/50 border-b">
                    <CardTitle className="text-3xl font-bold text-blue-900 flex items-center gap-3">
                        <span className="bg-blue-600 text-white p-3 rounded-lg">📊</span>
                        <div>
                            <h1>Agricultural Market Analytics</h1>
                            <p className="text-sm text-blue-600 font-normal mt-1">Real-time Commodity Pricing Trends</p>
                        </div>
                    </CardTitle>
                </CardHeader>
                <CardContent className="pt-6">
                    ...
                    >
                        <div className="space-y-1">
                            ...
                            <Input
                                className="rounded-lg border-gray-300 focus:ring-2 focus:ring-blue-500 shadow-sm"
                        ...
                        <Button
                            type="submit"
                            className="h-[42px] bg-blue-600 hover:bg-blue-700 rounded-lg font-semibold text-white shadow-md transition-all"
                        >
                            {loading ? (
  ...
  <Card className="border-0 shadow-xl">
    <CardHeader className="bg-gray-50 border-b space-y-2">
      ...
      <div className="flex items-center gap-2">
        ...
        <Input
          ...
          className="w-52 h-9 text-sm border-gray-300 shadow-sm rounded-md focus:ring-2 focus:ring-blue-500"
        />
      </div>
    </CardHeader>
    <CardContent>
      <div className="overflow-x-auto pb-4">
        <div className="flex gap-4 min-w-full whitespace-nowrap scrollbar-thin scrollbar-thumb-blue-400">
